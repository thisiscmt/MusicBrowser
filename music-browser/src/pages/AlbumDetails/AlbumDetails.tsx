...
import { Link as RouteLink, useParams, useSearchParams, useLocation } from 'react-router';
...
const AlbumDetails: FC<AlbumDetailsProps> = (props: AlbumDetailsProps) => {
    ...
    useEffect(() => {
        ...
        if (entity.name === '' && !error) {
            fetchData();
            SharedService.scrollToTop(props.topOfPageRef);
        }
    }, [albumId, entity.name, loading, props.topOfPageRef, searchParams, setBanner]);
